...
export const Footer = () => {
    return (
        <div className="bg-footer bg-no-repeat bg-cover bg-bottom">
            <footer className="max-w-2xl px-5 lg:px-0 container py-20 text-[#677168] space-y-5 flex flex-col items-center justify-center text-[35px]">
